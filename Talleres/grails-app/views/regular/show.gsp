	...
	<body>
		...
		<div id="show-regular" class="content scaffold-show" role="main">
			...
			<ol class="property-list regular">
				...
				<g:if test="${regularInstance?.startNumber}">
				<li class="fieldcontain">
					<span id="startNumber-label" class="property-label"><g:message code="regular.startNumber.label" default="Start Number" /></span>
					
						<span class="property-value" aria-labelledby="startNumber-label"><g:fieldValue bean="${regularInstance}" field="startNumber"/></span>
