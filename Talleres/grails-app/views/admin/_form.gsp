...
<div class="fieldcontain ${hasErrors(bean: adminInstance, field: 'level', 'error')} required">
	...
	<g:field name="level" type="number" min="0" max="5" value="${adminInstance.level}" required=""/>
...
<div class="fieldcontain ${hasErrors(bean: adminInstance, field: 'rating', 'error')} required">
	...
	<g:field name="rating" type="number" min="0" max="100" value="${adminInstance.rating}" required=""/>
